...
input <- st_read("DATA/GPKG/voronoi/com_vor.geojson")
...
st_write(out, "DATA/GPKG/voronoi/output/com.geojson")

# EPCI/ create insets
input <- st_read("DATA/GPKG/voronoi/epci.geojson")
met <- st_transform(met, 4326)
inter <- st_intersects(input, met, sparse = FALSE)
out <- input[inter,]
out <- st_transform(out, 2154)
...
out <- st_transform(out, 4326)
st_write(out, "DATA/GPKG/voronoi/output/epci.geojson")

# Departments
input <- st_read("DATA/GPKG/voronoi/dep.geojson")
met <- st_transform(met, 4326)
inter <- st_intersects(input, met, sparse = FALSE)
out <- input[inter,]
out <- st_transform(out, 2154)
...
out <- st_transform(out, 4326)
st_write(out, "DATA/GPKG/voronoi/output/dep.geojson")

# Regions
input <- st_read("DATA/GPKG/voronoi/reg.geojson")
met <- st_transform(met, 4326)
inter <- st_intersects(input, met, sparse = FALSE)
out <- input[inter,]
out <- st_transform(out, 2154)
...
out <- st_transform(out, 4326)
st_write(out, "DATA/GPKG/voronoi/output/reg.geojson")

# Neighboring country layer
countries <- st_read("DATA/GPKG/voronoi/neighbors.shp")
...
st_write(country_box, "DATA/GPKG/voronoi/output/country_box.geojson")
st_write(borders_box, "DATA/GPKG/voronoi/output/borders_box.geojson")
